...
// PLace Provider
  ...
  setSelectedLocation(String placeId) async {
    ...
    _locationPosition = LatLng(selectedLocationStatic.geometry.location.lat,
...
// _locationPosition = LatLng(currentLocation.latitude, currentLocation.longitude);
      ...
      Marker marker = Marker(
          markerId: markerId,
          position:
              LatLng(_locationPosition.latitude, _locationPosition.longitude),
          icon: pinLocationIcon,
          draggable: true,
          onDragEnd: (newPosition) {
            _locationPosition =
                LatLng(newPosition.latitude, newPosition.latitude);
            notifyListeners();
          });
  ...
  setCustomMapPin() async {
    _pinLocationIcon = await BitmapDescriptor.fromAssetImage(
        ImageConfiguration(devicePixelRatio: 5), "assets/marker.png");
  }
}
