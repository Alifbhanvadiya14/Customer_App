...
class _PastOrdersState extends State<PastOrders> {
                  ...
                  itemBuilder: (context, index) {
                    ...
                    if (booking["type"] == "vendor") {
                      return vendorOrderCard(
                          booking["vendor"],
                          booking["order_amount"].toString(),
                          booking["order_items"].toString(),
                          booking["order_id"].toString(),
                          booking["type"]);
                    } else if (booking["type"] == "hotel") {
                      return hotelOrderCard(
                          booking["hotel_name"],
                          booking["total_amount"].toString(),
                          booking["no_of_days"].toString(),
                      ...
                      return dryCleanOrderCard(
                          booking["dryclean_shop_name"],
                          booking["total_cost"].toString(),
                          booking["no_of_clothes"].toString(),
                          booking["booking_id"].toString(),
                          booking["type"],
  ...
  Widget vendorOrderCard(String vendor, String orderAmount, String orderItems,
  ...
  TextStyle detailsfont = TextStyle(fontSize: 18, fontWeight: FontWeight.w400);
}
